...
class Paciente extends CI_Controller {
	...
	public function index()
	{
		...
		$crud->set_table('tblpaciente');
		$crud->set_subject('Listado de Pacientes');

		$crud->fields("nombre", "apellidos", "telefono", "email","direccion","ciudad","identificacion","observaciones");
		$crud->required_fields("nombre", "apellidos", "telefono", "email","direccion","ciudad","identificacion","observaciones");
		...
		$crud->display_as("apellidos", "Apellidos del Paciente");
		...
		$this->load->view('paciente',$vector);
	}
}