<?php
/*
Esta pagna incluye el buscador el nombre del usuario, la imagen y las opciones del perfil y salr del sistema 
*/
?>
        <!-- Topbar -->
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <img class="img-profile rounded-circle" src="<?php echo base_url()?>/assets/uploads/fotoperfil/<?php echo $fotousuario?>">
                <?php } ?>
              </a>
